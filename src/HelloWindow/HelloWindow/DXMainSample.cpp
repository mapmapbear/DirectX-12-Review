...
void D3D12HelloWindow::LoadAssets()
{
    ...
    // Create the texture.
    {
        ...
        m_commandList->ResourceBarrier(1, get_rvalue_ptr(CD3DX12_RESOURCE_BARRIER::Transition(m_texture.Get(), D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE)));
...
void D3D12HelloWindow::PopulateCommandList()
{
    ...
    ID3D12DescriptorHeap* ppHeaps1[] = { m_cbvHeap.Get() };
